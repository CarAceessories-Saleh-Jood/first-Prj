...
public class InstallerTasks {
	...
	public void theAppointmentsWillNotBeFoundAndPrinted() {
	  assertFalse(installer.viewAppointments(email));
	}

	@Then("the booked appointments will not be found and printed")
	public void theBookedAppointmentsWillNotBeFoundAndPrinted() {
		  assertFalse(installer.viewAppointmentBookings(email));
